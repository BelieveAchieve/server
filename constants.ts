...
export const CERT_UNLOCKING = {
  ...
  [MATH_CERTS.ALGEBRA]: [MATH_SUBJECTS.ALGEBRA_ONE, MATH_SUBJECTS.ALGEBRA_TWO, MATH_SUBJECTS.PREALGREBA],
  ...
  [SCIENCE_CERTS.ENVIRONMENTAL_SCIENCE]: [SCIENCE_SUBJECTS.ENVIRONMENTAL_SCIENCE],
...
export const COMPUTED_CERTS = {
  ...
  [SUBJECTS.INTEGRATED_MATH_THREE]: [MATH_CERTS.PRECALCULUS, MATH_CERTS.STATISTICS],
