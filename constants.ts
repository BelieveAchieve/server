...
export const CERT_UNLOCKING = {
  ...
  algebra: [SUBJECTS.ALGEBRA, SUBJECTS.PREALGREBA],
...
export const COMPUTED_CERTS = {
  integratedMathOne: [SUBJECTS.ALGEBRA, SUBJECTS.GEOMETRY, SUBJECTS.STATISTICS],
  integratedMathTwo: [
    SUBJECTS.ALGEBRA,
    SUBJECTS.GEOMETRY,
    SUBJECTS.STATISTICS,
  ...
  satMath: [SUBJECTS.ALGEBRA, SUBJECTS.TRIGONOMETRY, SUBJECTS.GEOMETRY]
};
